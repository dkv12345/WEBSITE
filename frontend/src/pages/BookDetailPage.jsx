...
// Import icon info của bạn tại đây
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3 max-w-lg pt-2">
            <div className="flex items-center border border-gray-200 h-11 bg-white">
              <button onClick={handleDecrement} className="px-3 h-full"><Minus className="w-3.5 h-3.5" /></button>
              <span className="w-10 text-center text-xs font-black">{quantity}</span>
              <button onClick={handleIncrement} className="px-3 h-full"><Plus className="w-3.5 h-3.5" /></button>
            </div>
            <motion.button 
          ...
          <div id="book-details-tabs" className="pt-6">
            ...
            <div className="py-6 min-h-[140px]">
              ...
              {/* Tab Details: Layout theo yêu cầu */}
              {activeTab === "details" && (
